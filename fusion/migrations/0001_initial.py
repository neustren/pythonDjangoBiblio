    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-mobile', 'Mobile'), ('lni-stats-up', 'Gráfico'), ('lni-users', 'Usuário'), ('lni-cog', 'Engrenagem'), ('lni-rocket', 'Foguete'), ('lni-layers', 'Designer')], max_length=12, verbose_name='Icone')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fusion.cargo', verbose_name='Cargo')),
            ],
            options={
